...
ensure($argc === 2 && in_array($argv[1], ['fetch', 'render', 'check'], true), 'Usage: php scripts/sync-content.php fetch|render|check');
...
if ($argv[1] === 'fetch') file_put_contents($root . '/data/content.json', json_encode($snapshot, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES | JSON_THROW_ON_ERROR) . "\n");
